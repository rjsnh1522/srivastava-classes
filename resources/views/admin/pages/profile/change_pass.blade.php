            ...
            <div class="col s12 m12 l12">
                ...
                <div class="col s12 m12 l6">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <form class="achievementsForm right-alert" id="adminProfileForm" method="post" action="{{route('post.change.password')}}" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <label for="name">Old password*</label>
                                        <input id="name" name="oldPassword" type="text" data-error=".error" value="">
