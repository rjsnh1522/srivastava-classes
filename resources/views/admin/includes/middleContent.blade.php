            ...
            <div class="row">
                ...
                <div class="col s12 m6 l4">
                    <div id="profile-card" class="card">
                        ...
                        <div class="card-content">
                            <img src="{{url('resources/assets/images/avatar.jpg')}}" alt="" class="circle responsive-img activator card-profile-image">
                    ...
                    <div class="blog-card" >
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s2">
                                        <img src="{{url('resources/assets/images/avatar.jpg')}}" alt="" class="circle responsive-img valign profile-image">
                                    </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s4 no-padding">
                                        <a href="#"></a><img src="{{url('resources/assets/images/amazon.jpg')}}" alt="amazon" class="responsive-img">
